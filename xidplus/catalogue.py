...
def create_XIDp_SPIREcat_nocov(posterior, prior250, prior350, prior500):
    ...
    :param prior250: prior class for 250microns
    :param prior350: prior class for 350 microns
    :param prior500: prior class for 500 microns
...
def create_empty_XIDp_SPIREcat(nsrc):
    """creates an empty XIDp SPIRE catalogue in fits format required by HeDaM
    ...
    # ----table info-----------------------
    # first define columns
    c1 = fits.Column(name='HELP_ID', format='100A', array=np.empty((nsrc)))
