...
\usepackage{hyperref}
\title[HELP:XID+]
  {HELP: XID+, The Probabilistic De-blender for \emph{Herschel} SPIRE maps}\author[P.D. Hurley et al.]{P.D.~Hurley,$^1$\thanks{Email: p.d.hurley@sussex.ac.uk} S.~Oliver,$^1$ J.M.~Scudder,$^1$ M.~Betancourt,$^2$ S.~Duivenvoorden,$^1$ \newauthor 
 D.~Farrah,$^3$ M.~Griffin,$^4$ E.~Le Floc'h,$^5$ A.~Papadopoulos,$^6$ M.~Sargent,$^1$ M.~Vaccari,$^7$\newauthor I. ~Valtchanov,$^8$ L.~Wang$^9$\\
...
$^8$ESA; Villafranca del Castillo, Madrid, Spain\\
...
Seb Oliver acknowledges support from the Science  and  Technology  Facilities  Council (grant  numberST/L000652/1).
...
Special thanks goes to Yannick Roehlly for organisation of code, and Louise Winters for management within HELP. This paper make use of \textsc{Matplotlib} \citep{Hunter:2007} and Astropy, a community-developed core Python package for Astronomy \citep{Astropy-Collaboration:2013}. 
