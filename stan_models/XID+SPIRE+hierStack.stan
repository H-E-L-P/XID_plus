...
model {
  ...
  for (n in nsrc-nstack:nsrc) {
  f_vec_psw[n] ~lognormal(stack_mu_psw,stack_sigma_psw);//distribution of flux from high z sample
  f_vec_pmw[n] ~lognormal(stack_mu_pmw,stack_sigma_pmw);//distribution of flux from high z sample
  f_vec_plw[n] ~lognormal(stack_mu_plw,stack_sigma_plw);//distribution of flux from high z sample
  }
