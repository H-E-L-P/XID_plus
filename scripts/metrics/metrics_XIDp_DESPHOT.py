...
pdf_pages=PdfPages("error_density_flux_test_uninform_uniform_XIDp_DESPHOT_log.pdf")
...
for i in range(0,3):
    pdf_pages.savefig(metrics_plot_nodensity(psw_metrics_XIDp[i],fcat_sim['S250'][idx_xidp][ind_3mjy_psw],psw_metrics_XID[i],fcat_simXID['S250'][ind_1mjy_psw],bins,[r'$S_{True} (\mathrm{mJy})$',labels[i]],ylims[i],yscale=scale[i]))
    pdf_pages.savefig(metrics_plot_nodensity(pmw_metrics_XIDp[i],fcat_sim['S350'][idx_xidp][ind_3mjy_pmw],pmw_metrics_XID[i],fcat_simXID['S350'][ind_1mjy_pmw],bins,[r'$S_{True} (\mathrm{mJy})$',labels[i]],ylims[i],yscale=scale[i],cmap=plt.get_cmap('Greens')))
    pdf_pages.savefig(metrics_plot_nodensity(plw_metrics_XIDp[i],fcat_sim['S500'][idx_xidp][ind_3mjy_plw],plw_metrics_XID[i],fcat_simXID['S500'][ind_1mjy_plw],bins,[r'$S_{True} (\mathrm{mJy})$',labels[i]],ylims[i],yscale=scale[i],cmap=plt.get_cmap('Reds')))
